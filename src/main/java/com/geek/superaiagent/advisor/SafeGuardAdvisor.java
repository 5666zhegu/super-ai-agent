...
public class SafeGuardAdvisor implements CallAdvisor, StreamAdvisor {
	...
	private static final String DEFAULT_FAILURE_RESPONSE = "I'm unab00000le to respond to that due to sensitive content. Could we rephrase or discuss something else?";
